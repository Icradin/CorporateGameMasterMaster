...

{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
               PlayerRotation(TCKInput.GetAxis("touchpad", "Horizontal"), TCKInput.GetAxis("touchpad", "Vertical"));
            }
        ...
        private void PlayerRotation(float horizontal, float vertical)
        {
            ...
            Camera.main.transform.localEulerAngles = new Vector3(-rotation, Camera.main.transform.localEulerAngles.y, 0f);
        }
        ...
        private void GetInput(out float speed)
        {
            ...
            else
            {
                ...
                horizontal = TCKInput.GetAxis("joystick", "Horizontal");
                vertical = TCKInput.GetAxis("joystick", "Vertical");
            }
